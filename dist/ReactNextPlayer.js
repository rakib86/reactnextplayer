...
const ReactNextPlayer = ({ src, controls = true, autoplay = false, muted = false, loop = false, contextMenu = false, poster, width = "100%", height = "auto", className = "", color = "#ff0000", ambientGlow = false, onPlay, onPause, onTimeUpdate, onEnded, }) => {
    ...
    const togglePictureInPicture = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        if (videoRef.current) {
            try {
            ...
            try {
                ...
                for (let row = 0; row < gridSize; row++) {
                    for (let col = 0; col < gridSize; col++) {
                        ...
                        const gradient = glowCtx.createRadialGradient(glowX, glowY, 0, glowX, glowY, glowSize);
                        gradient.addColorStop(0, `rgba(${rBoosted}, ${gBoosted}, ${bBoosted}, 0.6)`);
                        gradient.addColorStop(0.5, `rgba(${rBoosted}, ${gBoosted}, ${bBoosted}, 0.2)`);
                        gradient.addColorStop(1, `rgba(${rBoosted}, ${gBoosted}, ${bBoosted}, 0)`);
