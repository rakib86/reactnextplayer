...
const ReactVidPlayer = ({ src, controls = true, autoplay = false, muted = false, loop = false, contextMenu = false, poster, width = "100%", height = "auto", className = "", color = "#ff0000", onPlay, onPause, onTimeUpdate, onEnded, }) => {
